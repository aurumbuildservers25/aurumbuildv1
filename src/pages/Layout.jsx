...
export default function Layout({ children }) {
  ...
  const [pathname, setPathname] = useState('/'); // Initialize pathname state
  ...
  const isDreamhousePage = pathname.includes('dreamhouse') || pathname.includes('Dreamhouse'); // Updated logic
  const isContactPage = pathname.includes('contact'); // Updated logic
